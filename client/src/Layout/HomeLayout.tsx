...
const HomeLayout = () => {
  return (
    <div className='h-screen'>
      <div className='hidden md:block absolute inset-0 h-full w-full bg-[#1D232A] bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:64px_64px] -z-10'>
